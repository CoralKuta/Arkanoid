...
public class YouWin implements Animation {
    ...
    public void doOneFrame(DrawSurface d) {
        ...
        d.setColor(shade);
        d.drawText(d.getWidth() / 3 + 30 - 4, d.getHeight() / 2 - 50 - 4, "You Win!", 55);
        d.drawText(d.getWidth() / 3 + 30 - 3,  d.getHeight() / 2 - 3, "Your score is " + this.score.getValue(), 30);
        d.drawText(d.getWidth() / 3 + 50 - 2, d.getHeight() / 2 + 50 - 2, "Press SPACE to exit", 20);
        ...
        d.drawText(d.getWidth() / 3 + 50, d.getHeight() / 2 + 50, "Press SPACE to exit", 20);
    }
